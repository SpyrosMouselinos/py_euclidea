...
def radical_axis(pc1, pc2):
    if isinstance(pc1, Circle):
        ...
        raise Exception("Unexpected type for radical axis: {}".format(type(pc1)))
    if isinstance(pc2, Circle):
        C2, r2 = pc2.c, pc2.r
    elif isinstance(pc2, Point):
        C2, r2 = pc2.a, 0
    else:
        raise Exception("Unexpected type for radical axis: {}".format(type(pc2)))
...
def reflect_by_point(obj, C):
    if isinstance(obj, Point):
        ...
        raise Exception("Unexpected type: {} of reflected object".format(type(obj)))
...
def rotate_about_point(obj, center, angle):
    if isinstance(obj, Point):
        ...
        raise Exception("Unexpected type: {} of rotated object".format(type(obj)))
...
def random_point_on(obj):
    if isinstance(obj, Circle):
        ...
        return obj.closest_on(random_point())
